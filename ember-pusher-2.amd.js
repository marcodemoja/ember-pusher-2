  ...
  function(__dependency1__, __exports__) {
    ...
    function initialize() {
      ...
      Ember.Application.initializer({
        ...
        initialize: function(InstanceApp) {
          var pusherController, options, pusher, dict;

          dict = 'pusher:main';
          InstanceApp.register(dict, Controller);

          pusherController = InstanceApp.lookup(dict);
          options = InstanceApp.PUSHER_OPTS;
          ...
          InstanceApp.inject('controller', 'pusher', dict);
          InstanceApp.inject('route', 'pusher', dict);
        }
      });
